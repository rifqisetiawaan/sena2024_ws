...
(cl:defmethod cl:initialize-instance :after ((m <yoloPos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'yoloPos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_yolo-msg:<yoloPos> is deprecated: use camera_yolo-msg:yoloPos instead.")))

(cl:ensure-generic-function 'x_bola-val :lambda-list '(m))
(cl:defmethod x_bola-val ((m <yoloPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_yolo-msg:x_bola-val is deprecated.  Use camera_yolo-msg:x_bola instead.")
  (x_bola m))

(cl:ensure-generic-function 'y_bola-val :lambda-list '(m))
(cl:defmethod y_bola-val ((m <yoloPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_yolo-msg:y_bola-val is deprecated.  Use camera_yolo-msg:y_bola instead.")
  (y_bola m))

(cl:ensure-generic-function 'x_kotak-val :lambda-list '(m))
(cl:defmethod x_kotak-val ((m <yoloPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_yolo-msg:x_kotak-val is deprecated.  Use camera_yolo-msg:x_kotak instead.")
  (x_kotak m))

(cl:ensure-generic-function 'y_kotak-val :lambda-list '(m))
(cl:defmethod y_kotak-val ((m <yoloPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_yolo-msg:y_kotak-val is deprecated.  Use camera_yolo-msg:y_kotak instead.")
  (y_kotak m))
