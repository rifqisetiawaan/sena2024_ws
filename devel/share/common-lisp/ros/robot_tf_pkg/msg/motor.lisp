...
(cl:defmethod cl:initialize-instance :after ((m <motor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_tf_pkg-msg:<motor> is deprecated: use robot_tf_pkg-msg:motor instead.")))

(cl:ensure-generic-function 'motor1-val :lambda-list '(m))
(cl:defmethod motor1-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_tf_pkg-msg:motor1-val is deprecated.  Use robot_tf_pkg-msg:motor1 instead.")
  (motor1 m))

(cl:ensure-generic-function 'motor2-val :lambda-list '(m))
(cl:defmethod motor2-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_tf_pkg-msg:motor2-val is deprecated.  Use robot_tf_pkg-msg:motor2 instead.")
  (motor2 m))

(cl:ensure-generic-function 'motor3-val :lambda-list '(m))
(cl:defmethod motor3-val ((m <motor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_tf_pkg-msg:motor3-val is deprecated.  Use robot_tf_pkg-msg:motor3 instead.")
  (motor3 m))
